...
const Footer = () => {
    return (
        <div class=" w-full overflow-x-hidden mt-8 bg-violet-900 pt-9">
                    ...
                    <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
                        ...
                        <div class="mt-6 flex flex-col gap-4 sm:mt-0">
                            ...
                            <div class="flex gap-4 sm:flex-col">
                                <a target="_blank"
                                    href="#"><img alt="facebook icon" loading="lazy" width="168" height="50" decoding="async" data-nimg="1"
                                        src="https://www.englishyaari.com/img/google-store.svg" /></a><a
                                            target="_blank"
